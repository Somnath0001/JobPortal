...
def login():
    # POST method - when user clicks submit/login (client -> server)
    ...
    # GET method - loads index.html - (server -> client)
    else:
        return render_template('index.html')
...
def register():
    # POST request - when user clicks submit button (client -> server)
    if request.method == 'POST':
    ...
    # GET request - loads the page (server -> client)
    else:
...
@app.route("/check_application_status")
...
@app.route("/job_seeker_profile", methods=['GET', 'POST'])
def job_seeker_profile():
    # POST method - when user clicks submit button
    if request.method == 'POST':
...
def educational_details():
    ...
    # GET method - loads educational_details.html
    else:
        return render_template('educational_details.html')
...
def skills():
    ...
    # GET method - loads skills.html page
    else:
        return render_template('skills.html')

# handle experience_details when user clicks submit button
@app.route("/experience_details", methods=['GET', 'POST'])
def experience_details():
    ...
    # GET method - loads experience_details.html page
    else:
...
def company_profile():
    ...
    if request.method == 'POST':
        ...
        return dashboard()
    # GET method - loads company.html page
    else:
...
def job_posting():
    ...
    # GET method - loads job_posting.html page
    else:
...
@app.route("/manage_application_status", methods=["GET", "POST"])
def manage_application_status():
    # POSt method - when "Accept", "Reject" or "Schedule for Interview" button is clicked in "manage_applicaiton.html"
    if request.method == 'POST':
    ...
    # GET method - loads manage_application_status.html page
    else:
        return generate_manage_application_status_html()
